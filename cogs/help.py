...
PUBLIC_COMMANDS = [
    ...
    ("Server Admin", "setup", [], "f.setup [#channel]", "Register or move this server's Fliphone channel.", "Manage Channels"),
    ("Server Admin", "check", ["setupcheck", "doctor"], "f.check", "Diagnose broken setup, permissions, webhook, and state.", "Manage Channels"),
    ("Server Admin", "repair", ["fixsetup", "fix"], "f.repair [#channel]", "Repair the configured channel/webhook after f.check.", "Manage Channels"),
    ("Server Admin", "teardown", ["remove"], "f.teardown", "Remove this server's Fliphone setup.", "Manage Channels"),
