...
PUBLIC_COMMANDS = [
    ...
    ("Calling", "leaderboard", ["lb", "levels", "rankings"], "f.lb", "Show the global Fliphone chat XP leaderboard.", "Everyone"),
    ("Calling", "serverlb", ["slb", "serverleaderboard"], "f.serverlb", "Show this server's chat XP leaderboard.", "Everyone"),
